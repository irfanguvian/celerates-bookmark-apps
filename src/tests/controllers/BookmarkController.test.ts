...
describe("BookmarkController", () => {
	...
	describe("getAllBookmarks", () => {
		it("should successfully get all bookmarks", async () => {
			...
			(bookmarkService.getAllBookmarks as jest.Mock).mockResolvedValue(
				serviceResponse,
			);
			...
			// Assert
			expect(bookmarkService.getAllBookmarks).toHaveBeenCalledWith(
				"user123",
				queryParams,
			);
	...
	describe("getBookmarkById", () => {
		it("should successfully get a bookmark by id", async () => {
			...
			// Act
			const result = await bookmarkController.getBookmarkById(
				mockContext as Context,
			);
	...
	describe("deleteBookmark", () => {
		it("should successfully delete a bookmark", async () => {
			...
			// Act
			const result = await bookmarkController.deleteBookmark(
				mockContext as Context,
			);
