...
describe('CategoryService', () => {
    ...
    describe('getAllCategories', () => {
        it('should get all categories for a user with default params', async () => {
            ...
            // Act
            const result = await categoryService.getAllCategories(userId, queryParams);
    ...
    describe('updateCategory', () => {
        it('should update category fields successfully', async () => {
            ...
            prismaMock.category.findFirst.mockResolvedValue(existingCategory as any);
            prismaMock.category.findFirst.mockResolvedValueOnce(existingCategory as any);
        ...
        it('should throw error if category not found', async () => {
            ...
            // Act & Assert
            await expect(categoryService.updateCategory(userId, categoryId, updateData))
                .rejects
                .toThrow(HTTPException);
        ...
        it('should throw error if updated name would create a duplicate', async () => {
            ...
            prismaMock.category.findFirst.mockResolvedValueOnce(duplicateCategory as any);
