...
describe('BookmarkService', () => {
    ...
    describe('createBookmark', () => {
        ...
        it('should throw error if category does not exist or belong to user', async () => {
            ...
            // Act & Assert
            await expect(bookmarkService.createBookmark(userId, bookmarkData))
                .rejects
                .toThrow('Category not found or does not belong to the user');
        });
    });
    ...
    describe('getBookmarkById', () => {
        ...
        it('should throw error if bookmark not found', async () => {
            ...
            // Act & Assert
            await expect(bookmarkService.getBookmarkById(userId, bookmarkId))
                .rejects
    ...
    describe('updateBookmark', () => {
        it('should update bookmark fields', async () => {
            ...
            // Act
            const result = await bookmarkService.updateBookmark(userId, bookmarkId, updateData);
        ...
        it('should throw error if bookmark not found', async () => {
            ...
            // Act & Assert
            await expect(bookmarkService.updateBookmark(userId, bookmarkId, updateData))
                .rejects
                .toThrow(HTTPException);
        });
    ...
    describe('deleteBookmark', () => {
        ...
        it('should throw error if bookmark not found', async () => {
            ...
            // Act & Assert
            await expect(bookmarkService.deleteBookmark(userId, bookmarkId))
                .rejects
                .toThrow(HTTPException);
        });
    });
